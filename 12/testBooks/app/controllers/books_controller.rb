...
#     @books = WillPaginate::Collection.create(1, 2) do |pager|
#         result = Book.find(:all, :limit => pager.per_page, :offset => pager.offset)
#         # inject the result array into the paginated collection:
#         pager.replace(result)
#
#         unless pager.total_entries
#           # the pager didn't manage to guess the total count, do it manually
#           pager.total_entries = Book.count
#         end
#       end


#    @books=Book.paginate(:page=>params[:page]||1,:per_page=>'2',:total_entries=>'5',:total_pages=>'10')
