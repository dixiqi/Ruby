namespace :enki do
  desc "Generates public/yadis.xrdf from site.yml, for OpenID delegation"
  task :generate_yadis => :environment do
    ...
    raise "open_id_delegation section not provided in config/site.yml" unless enki_config[:open_id_delegation]
